...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-row items-center justify-between font-bold text-white bg-black tablet:p-8">
        <div className='laptop:text-2xl '>
          <p>KRISHNA SHIFT</p>
        </div>
        <div className="flex flex-row items-center tablet:text-xl tablet:space-x-14 phone:space-x-2 phone:text-[10px] ">
          {header.map((item, index) => (
            <div
              key={index}
              className="relative phone:hidden tablet:flex"
