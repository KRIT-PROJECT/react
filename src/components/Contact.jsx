...
//           <div className="bg-purple-500 w-24 h-24 md:w-48 md:h-48 rounded-full flex justify-center items-center">
//             <span className="text-white text-4xl md:text-6xl">✉️</span>
//           </div>
//         </div>
